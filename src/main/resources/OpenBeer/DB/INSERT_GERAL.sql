...
INSERT INTO TS_PERMISSAOACESSO(PERMISSAO, DH_INCLUSAO, TG_INATIVO)
VALUES('ROLE_USER','2019-11-17',0);

INSERT INTO TS_PERMISSAOACESSO(PERMISSAO, DH_INCLUSAO, TG_INATIVO)
VALUES('ROLE_ADMIN','2019-11-17',0);

INSERT INTO TS_LOGIN(EMAIL, SENHA, TG_INATIVO, DH_INCLUSAO)
VALUES('wesley.santos','$2a$10$zQ.u0Ca8pqnWGorUtNLLU.KvgTvrYW77OWpNeru/ArNp22T/rZEnS',0,'2019-11-17');

INSERT INTO TS_LOGIN_PERMISSAOACESSO(LOGIN_PK_ID,	PERMISSAO_ACESSO_PK_ID)
VALUES(1,2);

INSERT INTO TB_CLIENTE(CPF, NOME, DT_NASCIMENTO, TG_SEXO, TELEFONE, FK_LOGIN, TG_INATIVO, DH_INCLUSAO)
VALUES('52923880099', 'WESLEY SANTOS', 1996-01-06, 'M','95555-7777',1,0,'2019-11-17');

INSERT INTO TB_TIPOCERVEJA (TIPOCERVEJA, TG_INATIVO, DH_INCLUSAO)
VALUES ('ARTESANAL',0,'2019-11-17');

INSERT INTO TB_TIPOCERVEJA (TIPOCERVEJA, TG_INATIVO, DH_INCLUSAO)
VALUES ('IMPORTADA',0,'2019-11-17');

INSERT INTO TB_TIPOCERVEJA (TIPOCERVEJA, TG_INATIVO, DH_INCLUSAO)
VALUES ('AMARGA',0,'2019-11-17');

INSERT INTO TB_TIPOCERVEJA (TIPOCERVEJA, TG_INATIVO, DH_INCLUSAO)
VALUES ('ADOCICADA',0,'2019-11-17');

INSERT INTO TB_STATUSPEDIDO (STATUSPEDIDO, DH_INCLUSAO, TG_INATIVO)
VALUES('PEDIDO EFETUADO', '2019-11-17', 0);

INSERT INTO TB_STATUSPEDIDO (STATUSPEDIDO, DH_INCLUSAO, TG_INATIVO)
VALUES('PEDIDO APROVADO', '2019-11-17', 0);

INSERT INTO TB_STATUSPEDIDO (STATUSPEDIDO, DH_INCLUSAO, TG_INATIVO)
VALUES('PEDIDO RECUSADO', '2019-11-17', 0);

INSERT INTO TB_STATUSPEDIDO (STATUSPEDIDO, DH_INCLUSAO, TG_INATIVO)
VALUES('PEDIDO EM TRANSPORTE', '2019-11-17', 0);

INSERT INTO TB_STATUSPEDIDO (STATUSPEDIDO, DH_INCLUSAO, TG_INATIVO)
VALUES('PEDIDO ENTREGUE', '2019-11-17', 0);

INSERT INTO TB_TIPOENTREGA(TIPOENTREGA,TG_INATIVO,DH_INCLUSAO, PRAZOENTREGA, VL_ENTREGA)
VALUES ('SEDEX -  15,00',0,'2019-11-17', 20,15.00);

INSERT INTO TB_TIPOENTREGA(TIPOENTREGA,TG_INATIVO,DH_INCLUSAO, PRAZOENTREGA, VL_ENTREGA)
VALUES ('PAC -  25,00',0,'2019-11-17',10,25.00);

INSERT INTO TB_CUPOM(DS_CUPOM, DH_INCLUSAO, DH_VALIDADE, VL_CUPOM)
VALUES ('CHAMANABREJA', '2019-11-17','2019-06-07 14:47:12',25.00);

INSERT INTO TB_CUPOM(DS_CUPOM,DH_INCLUSAO, DH_VALIDADE, VL_CUPOM)
VALUES ('BREJA10', '2019-11-17','2019-07-07 00:00:00',10.00);
...
INSERT INTO TS_LOGIN(EMAIL, SENHA, TG_INATIVO, DH_INCLUSAO)
VALUES('cliente@sandbox.pagseguro.com.br','$2a$10$zQ.u0Ca8pqnWGorUtNLLU.KvgTvrYW77OWpNeru/ArNp22T/rZEnS',0,'2019-11-17');

INSERT INTO TB_CLIENTE(CPF, NOME, DT_NASCIMENTO, TG_SEXO, TELEFONE, FK_LOGIN, TG_INATIVO, DH_INCLUSAO)
VALUES('39912182081', 'Cliente Teste', 1996-01-06, 'M','1195555-7777',2,0,'2019-11-17');

INSERT INTO TB_ENDERECO(BAIRRO, CEP, CIDADE, COMPLEMENTO, ESTADO, LOGRADOURO, NUMERO, FK_CLIENTE, DH_INCLUSAO, TG_INATIVO)
VALUES('Jardim Internet', '99999999', 'Cidade Exemplo', '99o andar', 'SP', 'Av. Senac', '9999', 2, '2019-11-17', 0);
